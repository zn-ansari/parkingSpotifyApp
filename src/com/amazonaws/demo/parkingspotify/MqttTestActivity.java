...
public class MqttTestActivity extends Activity {
    private static String msg_data = "Test_data";

//    public PubSubActivity(msgInterface msgInterface) {
//
//    }
...
//    create listener setter
    public msgInterface msgListener; //listener

    public MqttTestActivity(){
        this.msgListener = null;
    }

    public void setListener(msgInterface msgListener){
        this.msgListener = msgListener;
    }


    static final String LOG_TAG = MqttTestActivity.class.getCanonicalName();

    // --- Constants to modify per your configuration ---

    // IoT endpoint
    // AWS Iot CLI describe-endpoint call returns: XXXXXXXXXX.iot.<region>.amazonaws.com
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a1qbvgvdp6hvgv-ats.iot.us-east-1.amazonaws.com";
                        ...
                        public void run() {
                            ...
                            if(status.toString().equals("Connected")) {
                                ...
                                Toast.makeText(getApplicationContext(),
                                        ...
                                        .show();
                                flag = true;
                                final String parkingTopic = "Parking/Furnas/#";
                                try {
                                    mqttManager.subscribeToTopic(parkingTopic, AWSIotMqttQos.QOS0,
                                                    ...
                                                    runOnUiThread(new Runnable() {
                                                        ...
                                                        public void run() {
                                                            try {
                                                                ...
                                                                Log.d(LOG_TAG, "Message by me arrived:");
...
//                                                                rcvdMsg.setText(message);
                                                                switch (topic){
                                                                    case "Parking/Furnas/spot1":
//                                                                        Log.d(LOG_TAG, "Message inside swithc");
                                                                        if (message.equals("1"))
                                                                            spot1.setVisibility(View.INVISIBLE);
                                                                        else
                                                                            spot1.setVisibility(View.VISIBLE);
                                                                        break;
                                                                    case "Parking/Furnas/spot2":
//                                                                        Log.d(LOG_TAG, "Message inside swithc");
                                                                        if (message.equals("1"))
...
//                                                                        Log.d(LOG_TAG, "Message inside swithc");
                                                                        ...
                                                                        break;
                                                                    case "Parking/Furnas/spot4":
//                                                                        Log.d(LOG_TAG, "Message inside swithc");
                                                                        if (message.equals("1"))
                                                                            spot4.setVisibility(View.INVISIBLE);
                                                                        else
                                                                            spot4.setVisibility(View.VISIBLE);
                                                                        break;
                                                                    case "Parking/Furnas/spot5":
//                                                                        Log.d(LOG_TAG, "Message inside swithc");
                                                                        if (message.equals("1"))
                                                                            spot5.setVisibility(View.INVISIBLE);
                                                                        else
                                                                            spot5.setVisibility(View.VISIBLE);
                                                                        break;
                                                                    case "Parking/Furnas/spot6":
//                                                                        Log.d(LOG_TAG, "Message inside swithc");
                                                                        if (message.equals("1"))
                                                                            spot6.setVisibility(View.INVISIBLE);
                                                                        else
                                                                            spot6.setVisibility(View.VISIBLE);
                                                                        break;
                                                                    case "Parking/Furnas/spot7":
//                                                                        Log.d(LOG_TAG, "Message inside swithc");
                                                                        if (message.equals("1"))
                                                                            spot7.setVisibility(View.INVISIBLE);
                                                                        else
                                                                            spot7.setVisibility(View.VISIBLE);
                                                                        break;
                                                                    case "Parking/Furnas/spot8":
//                                                                        Log.d(LOG_TAG, "Message inside swithc");
                                                                        if (message.equals("1"))
                                                                            spot8.setVisibility(View.INVISIBLE);
                                                                        else
                                                                            spot8.setVisibility(View.VISIBLE);
                                                                        break;
                                                                        default:
                                                                            break;
...
//            if (flag){
//                Log.d(LOG_TAG, "Insidde flag  = " + String.valueOf(flag));
//                final String parkingTopic = "Parking/Furnas/#";
//                try {
//                    mqttManager.subscribeToTopic(parkingTopic, AWSIotMqttQos.QOS0,
//                            new AWSIotMqttNewMessageCallback() {
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Displaying simple Toast message
        Toast.makeText(getApplicationContext(),
                "Please click on Connect to see Parking Spots!",
                Toast.LENGTH_LONG)
                .show();
